...
Eigen::Vector3f Particle::getPredictedPosition() const { return pred_position; }
...
void Particle::setPredictedPosition(const Eigen::Vector3f &_pred_position){ pred_position = _pred_position; }
