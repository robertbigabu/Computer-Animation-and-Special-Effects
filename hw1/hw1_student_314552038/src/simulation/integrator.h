...
enum class IntegratorType : char { ExplicitEuler, ImplicitEuler, MidpointEuler, RungeKuttaFourth, PositionBasedDynamic};
...
class PositionBasedDynamicIntegrator final : public Integrator {
 public:
    PositionBasedDynamicIntegrator() = default;
    IntegratorType getType() override;
    void integrate(MassSpringSystem& particleSystem) override;
};
}  // namespace simulation
