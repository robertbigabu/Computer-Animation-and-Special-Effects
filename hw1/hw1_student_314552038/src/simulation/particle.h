...
class Particle {
 private:
    ...
    Eigen::Vector3f pred_position = Eigen::Vector3f::Zero();
 ...
 public:
    ...
    Eigen::Vector3f getPredictedPosition() const;
    ...
    void setPredictedPosition(const Eigen::Vector3f &_pred_position);
